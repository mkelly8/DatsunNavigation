...
// Note: SPI DMA is not supported on ESP32-S3 in TFT_eSPI 2.5.43 — disabled to prevent crash
// (spi_bus_initialize with SPI_DMA_CH_AUTO fails on S3, leaving device handle null)
#if !defined(TFT_PARALLEL_8_BIT) && !defined(SPI_18BIT_DRIVER) && !defined(CONFIG_IDF_TARGET_ESP32S3)
  #define ESP32_DMA
