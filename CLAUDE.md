...
## Hardware
- Board: ESP32-S3-DevKitC-1 N8R8 (8 MB Octal Flash, 8 MB OPI PSRAM)
- Port: COM4
- Framework: arduino
- Baud rate: 115200
...
Compile:
```
arduino-cli compile --fqbn esp32:esp32:esp32s3:UploadSpeed=115200,FlashSize=8M,PSRAM=opi,CDCOnBoot=cdc --libraries ../libraries .
```

Flash:
```
arduino-cli upload --fqbn esp32:esp32:esp32s3:UploadSpeed=115200,FlashSize=8M,PSRAM=opi,CDCOnBoot=cdc --port COM4 .
```
Monitor:
```
...
2. Compile: `arduino-cli compile --fqbn esp32:esp32:esp32s3:UploadSpeed=115200,FlashSize=8M,PSRAM=opi,CDCOnBoot=cdc .`
3. If compile fails, read the errors, fix them, and recompile. Do NOT flash broken code.
4. Flash: `arduino-cli upload --fqbn esp32:esp32:esp32s3:UploadSpeed=115200,FlashSize=8M,PSRAM=opi,CDCOnBoot=cdc --port COM4 .`
